...
input_path = uigetdir('C:\Users\Bewersdorf\Desktop\Lukas Fuentes\Data', 'Select Input Data File');
% Specify output path for results
output_path= uigetdir('C:\Users\Bewersdorf\Desktop\Lukas Fuentes\Data', 'Select Output File');
...
ExposureTime = 6; % in milliseconds
...
FileTif = uigetfile; %was '1_sp_stack.tif'
